...
<head>
    ...
    <title>登录</title>
    <link rel="stylesheet" href="{{asset('login/css/pintuer.css')}}">
    <link rel="stylesheet" href="{{asset('login/css/admin.css')}}">
                    ...
                    <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                        ...
                        <div class="form-group">
                            <div class="field">
                                ...
                                <img src="{{asset('login/images/passcode.jpg')}}" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;" onclick="this.src=this.src+'?'">
